...
IDSK Frontend obsahuje zdrojový kód, ktorý vychádza z [britského dizajnového manuálu elektronických služieb GOV.UK (GDS)](https://design-system.service.gov.uk/).

## idsk.gov.sk
"Živé" príklady IDSK komponentov s pokynmi ako ich využiť pri tvorbe vlastnej služby nájdete v [Dizajnovom manuále IDSK](https://idsk.gov.sk/).
...
## Kontakt na tím
IDSK je tvorený pod záštitou Oddelenia kvality používateľskej skúsenosti (oKPS) Ministerstva investícií, regionálneho rozvoja a informatizácie. Pre viac informácií svoje otázky smerujte na e-mail [IDSK tímu idsk@mirri.gov.sk](mailto:idsk@mirri.gov.sk).
...
Po inštalácii budete môcť vo vašej službe používať kód z dizajn systému IDSK.
